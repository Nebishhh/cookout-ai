...
- **Test counts** (see §9 for the full breakdown): 429 Vitest tests, 11 Playwright E2E tests, all passing.
...
| `POST`   | `/api/auth/logout`                          | Delete the current session and clear the cookie — idempotent                                                                                                                                            |
